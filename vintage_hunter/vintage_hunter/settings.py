...
PURCHASE_RESERVATION_MINUTES = env.int('PURCHASE_RESERVATION_MINUTES', default=15)

LOGIN_URL = 'signin'

AUCTION_DEFAULT_MIN_PARTICIPANTS = 3

USER_PREFERENCE_SEARCH_MAX_RESULT = 10
USER_PREFERENCE_SEARCH_FREQUENCY_MINUTES = 10
USER_PREFERENCE_SEARCH_EXAMPLES_COUNT = 5
